...
class QuantumEchoPlugin(object):
    ...
    def delete_network(self, context, tenant_id, net_id):
        """
    ...
    def get_network_details(self, context, tenant_id, net_id):
        """
    ...
    def update_network(self, context, tenant_id, net_id, **kwargs):
        print("update_network() called")

    def get_all_ports(self, context, tenant_id, net_id):
        """
    ...
    def create_port(self, context, tenant_id, net_id, **kwargs):
        """
        Creates a port on the specified Virtual Network.
        """
        print("create_port() called\n")

    def delete_port(self, context, tenant_id, net_id, port_id):
        """
    ...
    def update_port(self, context, tenant_id, net_id, port_id, **kwargs):
        """
        Updates the attributes of a port on the specified Virtual Network.
        """
        print("update_port() called\n")

    def get_port_details(self, context, tenant_id, net_id, port_id):
        """
    ...
    def plug_interface(self, context, tenant_id, net_id, port_id,
                       remote_interface_id):
        """
    ...
    def unplug_interface(self, context, tenant_id, net_id, port_id):
        """
...
class FakePlugin(object):
    ...
    def _get_network(self, context, tenant_id, network_id):

        db.validate_network_ownership(context, tenant_id, network_id)
        try:
    ...
    def _get_port(self, context, tenant_id, network_id, port_id):

        db.validate_port_ownership(context, tenant_id, network_id, port_id)
        net = self._get_network(context, tenant_id, network_id)
        try:
            port = db.port_get(context, port_id, network_id)
        except:
    ...
    def _validate_attachment(self, context, tenant_id, network_id, port_id,
                             remote_interface_id):
        for port in db.port_list(context, network_id):
    ...
    def get_network_details(self, context, tenant_id, net_id):
        ...
        ports = self.get_all_ports(context, tenant_id, net_id)
    ...
    def create_network(self, context, tenant_id, net_name, **kwargs):
        ...
        new_net = db.network_create(context, tenant_id, net_name)
        # Put operational status UP
        db.network_update(context, new_net.uuid, net_name,
    ...
    def delete_network(self, context, tenant_id, net_id):
        ...
        if net:
            for port in db.port_list(context, net_id):
                if port['interface_id']:
                    raise exc.NetworkInUse(net_id=net_id)
            db.network_destroy(context, net_id)
            return net
        # Network not found
    ...
    def update_network(self, context, tenant_id, net_id, **kwargs):
        ...
        net = db.network_update(context, net_id, tenant_id, **kwargs)
        return net

    def get_all_ports(self, context, tenant_id, net_id, **kwargs):
        """
        Retrieves all port identifiers belonging to the
        specified Virtual Network.
        """
        LOG.debug("FakePlugin.get_all_ports() called")
        db.validate_network_ownership(context, tenant_id, net_id)
        filter_opts = kwargs.get('filter_opts')
        if filter_opts:
            LOG.debug("filtering options were passed to the plugin"
                      "but the Fake plugin does not support them")
        port_ids = []
        ports = db.port_list(context, net_id)
        for x in ports:
    ...
    def create_port(self, context, tenant_id, net_id, port_state=None,
                    **kwargs):
        """
        Creates a port on the specified Virtual Network.
        """
        ...
        port = db.port_create(context, net_id, port_state)
        # Put operational status UP
        db.port_update(context, port.uuid, net_id,
                       op_status=OperationalStatus.UP)
    ...
    def update_port(self, context, tenant_id, net_id, port_id, **kwargs):
        ...
        self._get_network(context, tenant_id, net_id)
        self._get_port(context, tenant_id, net_id, port_id)
        port = db.port_update(context, port_id, net_id, **kwargs)
    ...
    def delete_port(self, context, tenant_id, net_id, port_id):
        ...
        if port['interface_id']:
            raise exc.PortInUse(net_id=net_id, port_id=port_id,
                                att_id=port['interface_id'])
        try:
            port = db.port_destroy(context, port_id, net_id)
        except Exception, e:
    ...
    def plug_interface(self, context, tenant_id, net_id, port_id,
        ...
        port = self._get_port(context, tenant_id, net_id, port_id)
        # Validate attachment
        self._validate_attachment(context, tenant_id, net_id, port_id,
                                  remote_interface_id)
        if port['interface_id']:
            raise exc.PortInUse(net_id=net_id, port_id=port_id,
                                att_id=port['interface_id'])
        db.port_set_attachment(context, port_id, net_id, remote_interface_id)
    ...
    def unplug_interface(self, context, tenant_id, net_id, port_id):
        ...
        db.port_unset_attachment(context, port_id, net_id)
